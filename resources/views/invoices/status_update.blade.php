...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="/invoices_paye" method="post" autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="hidden" value="{{ $invoice->id }}" name="id" id="id">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" onclick="console.log($(this).val())" required readonly>
                                    <!--placeholder-->
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="Amount_collection"
                                    ...
                                    value="{{ $invoice->Amount_collection }}" required readonly>
                            </div>
                        </div>
                        {{-- 3 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="Value_VAT" name="Value_VAT"
                                    value="{{ $invoice->Value_VAT }}" required readonly>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">الاجمالي شامل الضريبة</label>
                                <input type="text" class="form-control" id="Total" name="Total"
                                    value="{{ $invoice->Total }}" required readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input type="date" class="form-control" name="date_pay" id="date_pay"
                                    value="">
                            </div>
                        </div><br>

                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary">تغير حالة الدفع
                            </button>
                        </div>
                    </form>
                </div>
