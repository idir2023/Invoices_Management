...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/أرشفة الفواتير</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" data-effect="effect-scale"
                                                        ...
                                                        href="#delete1_invoices" title="أرشيف"><i
                                                            class="fas fa-archive mr-2"></i>نقل إلى الفواتير</a>
    ...
    <div class="modal" id="delete1_invoices">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">إلغاء الأرشفة</h6><button aria-label="Close" class="close"
                        data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <form action="archive/update" method="post">
                    ...
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <p>هل انت متاكد من عملية إلغاء الأرشفة ؟</p><br>
                        <input type="hidden" name="id" id="id" value="">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">الغاء</button>
